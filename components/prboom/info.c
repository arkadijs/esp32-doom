...
const state_t const rostates[NUMSTATES] = {
  ...
  {SPR_DOGS,0,10,(actionf_t)A_Look,S_DOGS_STND2},  // S_DOGS_STND
  {SPR_DOGS,1,10,(actionf_t)A_Look,S_DOGS_STND}, // S_DOGS_STND2
  {SPR_DOGS,0,2,(actionf_t)A_Chase,S_DOGS_RUN2}, // S_DOGS_RUN1
  {SPR_DOGS,0,2,(actionf_t)A_Chase,S_DOGS_RUN3}, // S_DOGS_RUN2
  {SPR_DOGS,1,2,(actionf_t)A_Chase,S_DOGS_RUN4}, // S_DOGS_RUN3
  {SPR_DOGS,1,2,(actionf_t)A_Chase,S_DOGS_RUN5}, // S_DOGS_RUN4
  {SPR_DOGS,2,2,(actionf_t)A_Chase,S_DOGS_RUN6}, // S_DOGS_RUN5
  {SPR_DOGS,2,2,(actionf_t)A_Chase,S_DOGS_RUN7}, // S_DOGS_RUN6
  {SPR_DOGS,3,2,(actionf_t)A_Chase,S_DOGS_RUN8}, // S_DOGS_RUN7
  {SPR_DOGS,3,2,(actionf_t)A_Chase,S_DOGS_RUN1}, // S_DOGS_RUN8
  {SPR_DOGS,4,8,(actionf_t)A_FaceTarget,S_DOGS_ATK2},  // S_DOGS_ATK1
  {SPR_DOGS,5,8,(actionf_t)A_FaceTarget,S_DOGS_ATK3},  // S_DOGS_ATK2
  {SPR_DOGS,6,8,(actionf_t)A_SargAttack,S_DOGS_RUN1},  // S_DOGS_ATK3
  {SPR_DOGS,7,2,NULL,S_DOGS_PAIN2}, // S_DOGS_PAIN
  {SPR_DOGS,7,2,(actionf_t)A_Pain,S_DOGS_RUN1},  // S_DOGS_PAIN2
  {SPR_DOGS,8,8,NULL,S_DOGS_DIE2},  // S_DOGS_DIE1
  {SPR_DOGS,9,8,(actionf_t)A_Scream,S_DOGS_DIE3},  // S_DOGS_DIE2
  {SPR_DOGS,10,4,NULL,S_DOGS_DIE4}, // S_DOGS_DIE3
  {SPR_DOGS,11,4,(actionf_t)A_Fall,S_DOGS_DIE5}, // S_DOGS_DIE4
